    ...
    <section class="bg-gray-100 flex justify-center mt-20">
        <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 mt-5">
            <div class="mr-auto place-self-center lg:col-span-7">
                <h1 class="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">Hi! My name is André</h1>
                ...
                <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
                  ...
                  I love Web App Development, Cloud Solutions and Serverless Applications, always looking for new things to explore and ways to automate daily tasks using what I have learned. 
